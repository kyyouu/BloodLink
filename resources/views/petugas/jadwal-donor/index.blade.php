                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-1">
                                ...
                                <form action="{{ route('petugas.jadwal-donor.destroy', $j->id) }}" method="POST"
...
<div class="modal fade" id="modalTambahJadwal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="border-radius:16px;border:none;box-shadow:0 20px 60px rgba(0,0,0,.15)">
            <form action="{{ route('petugas.jadwal-donor.store') }}" method="POST">
                @csrf
...
.bl-input:focus {
    border-color: #E8415A !important;
    box-shadow: 0 0 0 3px rgba(232,65,90,.1) !important;
...
.bl-toggle-input:checked + .bl-toggle-label {
    background: #E8415A;
}
.bl-toggle-input:checked + .bl-toggle-label::after {
